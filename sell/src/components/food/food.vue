<template>
  <transition name="fade">
    <div id="food" v-show="showFlag" ref="foodScroll">
      <div class="food-content">
        ...
        <div class="rating">
          ...
          <ratingselect @select-type="SelectType" @toggle-content="OnlyContent" :select-type="selectType" :only-content="onlyContent" :desc="desc"
